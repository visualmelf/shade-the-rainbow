...
sampleButtons = function()
{
	...
	exampleButtons.on("click", function() {
		...
		if($(this).text() ==="Lucy")
		{
			...
			image1.src = "images/dark.png"//dark
			image2.src = "images/white.png"//bright
			image3.src = "images/white.png"; //shape map
			image4.src = "images/dark.png";  //reflection
			image5.src = "images/dark.jpg";  //refraction	
			image6.src = "images/white.png"; //alpha
			image7.src = "images/hts/lucy.png"; //height field
			image8.src = "images/area_light_red2.png"; // Env light
		...
		if($(this).text() ==="Skull")
		{
			...
			image5.src = "images/dark.jpg";  //refraction	
			image6.src = "images/white.png"; //alpha
			image7.src = "images/hts/skull.png"; //height field
			image8.src = "images/area_light_red2.png"; // Env light
		...
		if($(this).text() ==="Dragon")
		{
			...
			image5.src = "images/dark.jpg";  //refraction	
			image6.src = "images/white.png"; //alpha
			image7.src = "images/hts/dragon.png"; //height field
			image8.src = "images/area_light_red2.png"; // Env light
		}
		...
		if($(this).text() ==="Buddha")
		{
			...
			image5.src = "images/dark.jpg";  //refraction	
			image6.src = "images/white.png"; //alpha
			image7.src = "images/hts/buddha1.png"; //height field
			image8.src = "images/area_light_red2.png"; // Env light
		}
...
UPLOADinit = function()
{
	...
	image1.src = "images/dark.png"//dark
	image2.src = "images/white.png"//bright
	image3.src = "images/area_light_red2.png";  //shape
	image4.src = "images/trees.jpg";  //reflection
	image6.src = "images/white.png"; //alpha
	image5.src = "images/tree_blurry.jpg";  //refraction	
	image7.src = 'images/dark.png'; // height field
	image8.src = 'images/dark.png'; // environment light
